...
vote_mun_zone_fed <- function(year, 
  ...
  .Deprecated("elections_tse", msg = "vote_mun_zone_fed is deprecated and will no longer be supported in electionsBR 1.0.0. Please use the elections_tse function")
